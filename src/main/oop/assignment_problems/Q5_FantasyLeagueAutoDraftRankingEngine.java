...
public class Q5_FantasyLeagueAutoDraftRankingEngine {
    ...
    static class Player implements Comparable<Player> {
        ...
        // Newer players need enough experience and must not be injured.
        static boolean isDraftable(int matchesPlayed, boolean injured) {
            return matchesPlayed >= 5 && !injured;
        }

        // The problem provides battingAverage as the performance measure
        // for ranking, so use it as the fantasy ranking score.
